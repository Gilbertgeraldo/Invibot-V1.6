...
baterai = 'unknown'
NamaOwner = '©Lord_Rifza'
NamaBot = 'XM-Bot'
NomorOwner = '6287708357324'
...
const starts = async (rifza = new WAConnection()) => {
    ...
    wann.browserDescription = [ 'XMOODS', 'Aloha', '5.4' ]
...
buttons: gbutsan,
headerType: 4 }
			wann.sendMessage(mdata.id, buttonMessages, MessageType.buttonsMessage, {thumbnail: fs.readFileSync('./gambar/thumb.jpg'), "contextInfo": { mentionedJid: [num]}, caption: 'Tes', quoted: fkontakk})

...
©Created by Rifza`, imageMessage: imageMsg,
               ...
               prep = await rifza.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftroli, contextInfo:{ forwardingScore:508, isForwarded:true, mentionedJid:[sender]}})
                          rifza.relayWAMessage(prep)
               break
...
`
    ...
    {buttonId: `${prefix}command`, buttonText: {displayText: '⬅️BACK TO MENU'}, type: 1},
               ...
               imageMsg = (await rifza.prepareMessageMedia(fs.readFileSync(`./gambar/thumb.jpg`), 'imageMessage', { thumbnail:Rfake, contextInfo:{forwardingScore: 989, isForwarded: true }})).imageMessage
...
rifza.sendMessage(from,{url:'./'+memek},audio,{mimetype:'audio/mpeg'})
       ...
       case 'tiktoknowm':
              ...
              prep = await rifza.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
...
case 'runtest':
			     ...
			     const timestamp = speed();
					const latensie = speed() - timestamp
					exec(`neofetch --stdout`, (error, stdout, stderr) => {
					child = stdout.toString('utf-8')
					 teks = child.replace(/Memory:/, "Ram:")
					 pingnya = `\`\`\`${teks}Speed: ${latensie.toFixed(4)} Sec 💬\`\`\``
					sendButDocument(from, `${pingnya}`, "*_© XMOODS_*", fs.readFileSync('./gambar/RIFZA'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./gambar/thumb.jpg'), filename:`${jmn} - ${week} - ${calender}`}, [{buttonId:`!speed`,buttonText:{displayText:'Speed'},type:1},{buttonId:`!runtime`,buttonText:{displayText:'BOT INFO'},type:1},{buttonId:`!menu3`,buttonText:{displayText:'Menu '},type:1}], {quoted:riff, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hy ${pushname}`,body:`click here to play music`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/g0lQESej9zc`}}})
                   break     
...
if (isBanned) return reply(mess.ban)
if (isBanchat) return
menu =`${runtime(process.uptime())}`
sendButDocument(from, `${menu}`, "*_© XMOODS_*", fs.readFileSync('./gambar/RIFZA'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./gambar/thumb.jpg'), filename:`${jmn} - ${week} - ${calender}`}, [{buttonId:`speed`,buttonText:{displayText:'Speed'},type:1},{buttonId:`runtest`,buttonText:{displayText:'BOT INFO'},type:1},{buttonId:`Menu3`,buttonText:{displayText:'Menu '},type:1}], {quoted:riff, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hy ${pushname}`,body:`click here to play music`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/g0lQESej9zc`}}})
break     
case 'ping':
case 'speed':
if (isBanned) return reply(mess.ban)
...
sendButDocument(from, `${menu}`, "*_© XMOODS_*", fs.readFileSync('./gambar/RIFZA'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./gambar/thumb.jpg'), filename:`${jmn} - ${week} - ${calender}`}, [{buttonId:`!runtime`,buttonText:{displayText:'Runtime'},type:1},{buttonId:`!runtest`,buttonText:{displayText:'BOT INFO'},type:1},{buttonId:`!menu3`,buttonText:{displayText:'Menu '},type:1}], {quoted:riff, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hy ${pushname}`,body:`click here to play music`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/g0lQESej9zc`}}})
break     
case 'gachacecan':
if (isBanned) return reply(mess.ban)
if (isBanchat) return
